...
public class KostRecyclerViewAdapter extends RecyclerView.Adapter<KostRecyclerViewAdapter.ViewHolder> {

    private ArrayList<KostModel> mKostData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    public KostRecyclerViewAdapter(Context context, ArrayList<KostModel> kostData) {
    ...
    public int getKostId(int id) {
        return mKostData.get(id).getKostId();
    }
